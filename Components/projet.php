...
<div class="max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto ">
  ...
  <div class="grid sm:grid-cols-12 gap-6">
    <div class="sm:self-end col-span-12 sm:col-span-7 md:col-span-8 lg:col-span-5 lg:col-start-2">
    ...
    <div class="hidden sm:block col-span-12 sm:col-span-6 md:col-span-3">
      <!-- Card -->
      <a data-aos="zoom-in" class="projet group relative block rounded-xl overflow-hidden dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="https://7develop.com/BookConnect/">
        <div class="aspect-w-12 aspect-h-7 sm:aspect-none rounded-xl overflow-hidden">
          <img class="group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-xl w-full object-cover" src="Assets/image/bookconnect.jpg" alt="Image Description">
        </div>
        <div class="absolute bottom-0 start-0 end-0 p-2 sm:p-4">
          <div class="projet-text text-sm font-bold text-gray-800 rounded-lg bg-white p-4 md:text-xl dark:bg-gray-800 dark:text-gray-200">
