...
<section id="testimony">
    <h1 class="block font-medium text-gray-200 text-4xl sm:text-5xl md:text-6xl  text-center" data-aos="fade-up"><?php echo lang('temoignage_section_title'); ?></h1>
    ...
    <div class=" mt-20 ">
        ...
        foreach ($testimony as $s) { ?>
            ...
            <div class="relative p-6 border border-blue-600 rounded flex m-16 " data-aos="fade-up">
